...
- 🌐 **Site:** **<https://jump-start-2026-sae-grupo-supra.github.io/Prototype-BLOOM/>** — laudo interativo por pack, com glossário, o dataset explicado, o método de desenvolvimento, as equações com fonte e a seção do pack do Corolla híbrido. Publicado pelo GitHub Pages a partir de [`docs/`](docs/) na `main`.
...
**Ver o site localmente** (o Pages publica `docs/` na `main`; para revisar antes de dar push):
